...
docker build -f DotNetFrameworkBuilder/Dockerfile -t "$repo/dotnet-framework:4.7.2-runtime-windowsservercore-insider-10.0.17666.1000" DotNetFrameworkBuilder
